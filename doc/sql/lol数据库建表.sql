...
create table discount_info(
 dis_id int not null  auto_increment primary key, -- 优惠券id
...
create table address_info(
	address_id int not null auto_increment primary key, -- 收货地址ID
	user_id int not null, -- 用户ID
...
create table city_info(
	city_code varchar(32) not null  auto_increment primary key, -- 地区码
...
create table collect_info(
	collect_id int not null auto_increment primary key, -- 收藏ID
	user_id int not null, -- 用户ID
	 product_id int not null -- 商品ID
)auto_increment=1000

-- 浏览表
create table browse_info(
	browse_id int not null auto_increment primary key, -- 收藏ID
	user_id int not null, -- 用户ID
 product_id int not  null,-- 商品ID
...
create table comment_info(
	com_id int not null auto_increment  primary key, -- 评论ID
	user_id int not null, -- 用户ID
	...
	com_date DateTime  default CURRENT_TIMESTAMP , -- 评论时间（当前时间）
...
create table comment_photo	(
	photo_id int not null  auto_increment primary key, -- 图片表id
...
create table order_details(
    ...
    specs_id INT not null	#商品规格id(关联商品规格表)
)auto_increment=1000;
...
shop_state	bit	Not null#购物车状态 0是未选中 1是选中
)auto_increment=1000
...
specs_id	Int	NOT NULL,#商品规格id
product_id	Int	NOT NULL	,#关联商品的Id
product_specs	varchar(100)	NOT NULL	,#记录每个规格的信息
specs_price	Decimal（16,2）	NOT NULL,	#每个规格商品的价格
specs_stock	Int	NOT NULL,#每个规格商品的库存
specs_create_time	DateTime	DEFAULT current_timestamp	NOT NULL,#每个规格创建时间（默认为当前时间）
specs_create_time	DateTime	NOT NULL,#每个规格修改时间（默认为当前时间）
specs_state	Int	NOT NULL	#商品规格的状态
)auto_increment=1000
...
attribute_value_name	varchar(200)	NOT NULL,	#属性value的名称
